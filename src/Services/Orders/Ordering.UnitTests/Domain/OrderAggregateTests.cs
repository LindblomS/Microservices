...
namespace Ordering.UnitTests.Domain
{
    public class OrderAggregateTests
    {
        ...
        public void Create_order_item_success()
        {
            ...
            //Act 
            var fakeOrderItem = new OrderItem(productId, productName, pictureUrl, unitPrice, discount, units);
        ...
        public void Invalid_number_of_units()
        {
            ...
            //Act - Assert
            Assert.Throws<OrderingDomainException>(() => new OrderItem(productId, productName, pictureUrl, unitPrice, discount, units));
        }
        ...
        public void Add_new_Order_raises_new_event()
        {
            ...
            //Act 
            var fakeOrder = new Order("1", "fakeName", new Address(street, city, state, country, zipcode), cardTypeId, cardNumber, cardSecurityNumber, cardHolderName, cardExpiration, null, null);
