...
namespace EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        private readonly IRabbitMQPersistentConnection _persistentConenction;
        ...
        public EventBusRabbitMQ(
            ...
            int retryCount = 5)
        {
            _persistentConenction = persistentConnection ?? throw new ArgumentNullException(nameof(persistentConnection));
        ...
        {
            if (!_persistentConenction.IsConnected)
                _persistentConenction.TryConnect();
            ...
            using (var channel = _persistentConenction.CreateModel())
            {
            ...
            where TH : IIntegrationEventHandler<T>
        {
            ...
            _logger.LogInformation($"Subscribing to dynamic event {eventName} with {typeof(TH).GetGenericTypeName()}");
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            var channel = _persistentConenction.CreateModel();
            channel.ExchangeDeclare(exchange: BROKER_NAME, type: "direct");
